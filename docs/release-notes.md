...
Releases are built and published by the anago tool in [this repo](https://github.com/kubernetes/release) with the release notes published in [kubernetes/CHANGELOGS/CHANGELOG-x.y.md files](https://github.com/kubernetes/kubernetes).
